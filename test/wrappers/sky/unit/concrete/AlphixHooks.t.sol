 ...
 * @author Alphix
 * @notice Unit tests for the Alphix4626WrapperSky hook management functions.
 * @dev Tests addAlphixHook, removeAlphixHook, isAlphixHook, and getAllAlphixHooks.
 */
contract AlphixHooksTest is BaseAlphix4626WrapperSky {
    ...
    function test_addAlphixHook_revertsIfAlreadyExists() public {
        ...
        vm.prank(owner);
        vm.expectRevert(IAlphix4626WrapperSky.HookAlreadyExists.selector);
    ...
    function test_removeAlphixHook_emitsEvent() public {
        vm.expectEmit(true, false, false, false);
        emit AlphixHookRemoved(alphixHook);
    ...
    function test_removeAlphixHook_revertsIfNotExists() public {
        ...
        vm.prank(owner);
        vm.expectRevert(IAlphix4626WrapperSky.HookDoesNotExist.selector);
    ...
    function test_removeAlphixHook_hookCanNoLongerDeposit() public {
        ...
        usds.mint(alphixHook, depositAmount * 2);
