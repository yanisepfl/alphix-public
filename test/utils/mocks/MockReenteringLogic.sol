...
/**
 * @dev Minimal logic that supports IAlphix and tries to re-enter hook.poke from poke
 */
contract MockReenteringLogic is IERC165 {
    ...
    /**
     * @dev Pretend to support IAlphix for ERC165 checks if any
     */
    ...
    /**
     * @dev Signature matches IAlphix.poke, but implementation attempts a re-entrancy
     */
