 ...
 * @dev Configures FEE_POKER_ROLE, HOOK_FEE_ROLE, and PAUSER_ROLE permissions
 *
...
contract ConfigureRolesLVRFeeScript is Script {
    uint64 constant HOOK_FEE_ROLE = 3;
    ...
    function run() public {
        ...
        // Step 2: Grant HOOK_FEE_ROLE for setHookFee() and setTreasury() (admin-only)
        console.log("Step 2: Setting up HOOK_FEE_ROLE (admin)...");
        ...
        accessManager.setTargetFunctionRole(hookAddr, hookFeeSelectors, HOOK_FEE_ROLE);
        // HOOK_FEE_ROLE granted to the script caller (admin) by default via ADMIN_ROLE
        ...
        console.log("  - HOOK_FEE_ROLE (", HOOK_FEE_ROLE, "): admin (setHookFee, setTreasury)");
